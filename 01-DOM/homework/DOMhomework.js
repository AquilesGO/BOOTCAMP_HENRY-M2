...
// Tu código acá:
var selectionSpan = document.querySelector('#createdBy')
selectionSpan.innerHTML += "Aquileo Gutiérrez"

// #n ---> selecciona un TAG por ID
// .n ---> selecciona TAG por su clase
// n ---> selecciona el primer TAG que coincida con "h1"
...
// toDoText.id = index; <--- forma corta accediendo a la propiedad del objeto document.
...
if(toDoInput.value){
  ...
  alert("Por favor ingresar al menos 1 caracter")
}
displayToDos();
}
